  ...
  return (
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-12'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          <p>Welcome To MediCare, Your Trusted Partner In Managing Your Healthcare Needs Conveniently And Efficiently.
            At Medicare, We Understand The Challenges Individuals Face When It Comes To Scheduling Doctor Appointments And Managing Their Health Records.</p>
      ...
      <div className='text-xl my-4'>
        <p>WHY <span className='text-gray-700 font-sembold'>CHOOSE US</span></p>
      </div>
      <div className='flex flex-col md:flex-row mb-20'>
        <div className='border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white hover:bg-blue-500 transition-all duration-300 text-gray-600 cursor-pointer'>
          <b>EFFICIENCY</b>
