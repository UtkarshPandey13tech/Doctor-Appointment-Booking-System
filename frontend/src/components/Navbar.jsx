...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        style={{ ...navStyle, visibility: showMenu ? "hidden" : "visible" }}
        id="main-navbar"
      ...
      >
        ...
        {/* Right actions — desktop only; mobile uses sidebar */}
            ...
            <div className="relative group cursor-pointer">
              ...
              >
                ...
                <img
                  ...
                  alt=""
                  style={{ width: "10px", opacity: 0.6 }}
                />
              </div>

              {/* Dropdown */}
              <div
                className="absolute top-full right-0 pt-3 hidden group-hover:block animate-fadeIn"
